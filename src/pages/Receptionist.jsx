    ...
    <div className="receptionist-page">
      ...
      <div className="main-container">
        ...
        <main className="main-content">
          ...
          {/* New Patient Registration Banner */}
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <div className="select-wrapper">
                    <select id="visitType" value={activeVisitType} onChange={(e) => setActiveVisitType(e.target.value)}>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <div className="priority-buttons">
                    <button className={`priority-btn normal ${activePriority === 'normal' ? 'active' : ''}`} onClick={() => setActivePriority('normal')}>
                    ...
                    <button className={`priority-btn urgent ${activePriority === 'urgent' ? 'active' : ''}`} onClick={() => setActivePriority('urgent')}>
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginRight:'6px'}}>
